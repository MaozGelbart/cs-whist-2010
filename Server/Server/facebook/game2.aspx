<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="game2.aspx.cs" Inherits="Server.facebook.game2" %>
    ...
    <div id="silverlightControlHost" style="height:680px; width:1020px;" >
        <object data="data:application/x-silverlight-2," type="application/x-silverlight-2" width="98%" height="98%">
		  ...
		  <param name="autoUpgrade" value="true" />
           <param name="initParams" value="viewMode=facebook" id="initParams_SL" runat="server" />
