...
namespace WCFServer
{
    ...
    public class PlayerService : IPlayerService
    {
        ...
        public void StartGame(string name, int numberOfAIPlayers, string[] player_AI)
        {
            PlayerSLAdaptor adaptor = new PlayerSLAdaptor(name,
                OperationContext.Current.SessionId,
                OperationContext.Current.GetCallbackChannel<IPlayerClient>());
            PlayerService.Adaptors.Add(adaptor.SessionID, adaptor);
            Brain.GameFactory.CreateGame(adaptor, numberOfAIPlayers, player_AI);
        }
        ...
        public void StartGameView(string[] player_AI)
        {
            ...
            Brain.GameFactory.CreateGame(adaptor, player_AI);
        }
