...
namespace TestClient.GameService {
    ...
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Runtime.Serialization", "4.0.0.0")]
    [System.Runtime.Serialization.DataContractAttribute(Name="PlayerPlugin", Namespace="http://schemas.datacontract.org/2004/07/WCFServer")]
    ...
    public interface IPlayerService {
        ...
        System.IAsyncResult BeginStartGame(string name, int numberOfAIPlayers, System.Collections.ObjectModel.ObservableCollection<string> player_AI, System.AsyncCallback callback, object asyncState);
        ...
        System.IAsyncResult BeginStartGameView(System.Collections.ObjectModel.ObservableCollection<string> player_AI, System.AsyncCallback callback, object asyncState);
    ...
    public partial class PlayerServiceClient : System.ServiceModel.DuplexClientBase<TestClient.GameService.IPlayerService>, TestClient.GameService.IPlayerService {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult TestClient.GameService.IPlayerService.BeginStartGame(string name, int numberOfAIPlayers, System.Collections.ObjectModel.ObservableCollection<string> player_AI, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginStartGame(name, numberOfAIPlayers, player_AI, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginStartGame(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string name = ((string)(inValues[0]));
            int numberOfAIPlayers = ((int)(inValues[1]));
            ...
            return ((TestClient.GameService.IPlayerService)(this)).BeginStartGame(name, numberOfAIPlayers, player_AI, callback, asyncState);
        }
        ...
        public void StartGameAsync(string name, int numberOfAIPlayers, System.Collections.ObjectModel.ObservableCollection<string> player_AI) {
            this.StartGameAsync(name, numberOfAIPlayers, player_AI, null);
        }
        
        public void StartGameAsync(string name, int numberOfAIPlayers, System.Collections.ObjectModel.ObservableCollection<string> player_AI, object userState) {
            ...
            base.InvokeAsync(this.onBeginStartGameDelegate, new object[] {
                        name,
                        numberOfAIPlayers,
                        player_AI}, this.onEndStartGameDelegate, this.onStartGameCompletedDelegate, userState);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.IAsyncResult TestClient.GameService.IPlayerService.BeginStartGameView(System.Collections.ObjectModel.ObservableCollection<string> player_AI, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginStartGameView(player_AI, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginStartGameView(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return ((TestClient.GameService.IPlayerService)(this)).BeginStartGameView(player_AI, callback, asyncState);
        }
        ...
        public void StartGameViewAsync(System.Collections.ObjectModel.ObservableCollection<string> player_AI) {
            this.StartGameViewAsync(player_AI, null);
        }
        
        public void StartGameViewAsync(System.Collections.ObjectModel.ObservableCollection<string> player_AI, object userState) {
            ...
            base.InvokeAsync(this.onBeginStartGameViewDelegate, new object[] {
                        player_AI}, this.onEndStartGameViewDelegate, this.onStartGameViewCompletedDelegate, userState);
        }
        ...
        private class PlayerServiceClientChannel : ChannelBase<TestClient.GameService.IPlayerService>, TestClient.GameService.IPlayerService {
            ...
            public System.IAsyncResult BeginStartGame(string name, int numberOfAIPlayers, System.Collections.ObjectModel.ObservableCollection<string> player_AI, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[3];
                _args[0] = name;
                _args[1] = numberOfAIPlayers;
                _args[2] = player_AI;
            ...
            public System.IAsyncResult BeginStartGameView(System.Collections.ObjectModel.ObservableCollection<string> player_AI, System.AsyncCallback callback, object asyncState) {
                object[] _args = new object[1];
                _args[0] = player_AI;
